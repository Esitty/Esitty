...
| Pivot Tables & Charts | MySQL | Fuel distribution & stock variance | Predictive modelling |
| Tableau | pandas, numpy | Supply chain management | Time series forecasting |
| Dashboard & KPI design | scikit-learn | Business intelligence | Demand planning |
| Data storytelling | matplotlib | Operations team leadership | Supplier performance analysis |
...
### [Fuel Sales, Logistics & Stock Buffer Analysis Dashboard](https://github.com/Esitty/fuel_sales_logistics_dashboard) · `Live on Tableau Public`
